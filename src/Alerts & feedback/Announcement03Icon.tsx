...
const Announcement03Icon = forwardRef<SVGSVGElement, ISVGProps>((props, ref) => (
	<svg height="24" width="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" ref={ref} {...props}>
		<path
			d="M22 9.5C22 13.0899 20.433 16 18.5 16C16.567 16 15 13.0899 15 9.5C15 5.91015 16.567 3 18.5 3C20.433 3 22 5.91015 22 9.5Z"
			fill="currentColor"
			opacity="0.12"
		/>
		<path
...
export default Announcement03Icon;
