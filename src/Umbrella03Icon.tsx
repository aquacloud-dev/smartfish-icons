...
const Umbrella03Icon = forwardRef<SVGSVGElement, ISVGProps>((props, ref) => (
	<svg height="24" width="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" ref={ref} {...props}>
		<path
			d="M17.0002 3.33977C15.0871 2.23521 11.2976 5.2171 8.53613 10L15.4643 14C18.2258 9.2171 18.9134 4.44434 17.0002 3.33977Z"
			fill="currentColor"
			opacity="0.12"
		/>
		<path
