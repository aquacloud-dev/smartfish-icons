...
const AlarmClockOffIcon = forwardRef<SVGSVGElement, ISVGProps>((props, ref) => (
	<svg height="24" width="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" ref={ref} {...props}>
		<path
			d="M17.6569 18.6569C16.1566 20.1571 14.1217 21 12 21C9.87827 21 7.84344 20.1571 6.34315 18.6569C4.84285 17.1566 4 15.1217 4 13C4 10.8783 4.84285 8.84344 6.34315 7.34315C6.50948 7.17682 6.68237 7.01857 6.86123 6.86865L18.1356 18.1337C17.9844 18.3144 17.8247 18.489 17.6569 18.6569Z"
			fill="currentColor"
			opacity="0.12"
		/>
		<path
