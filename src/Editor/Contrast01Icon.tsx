...
const Contrast01Icon = forwardRef<SVGSVGElement, ISVGProps>((props, ref) => (
	<svg height="24" width="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" ref={ref} {...props}>
		<path d="M2 12C2 17.5228 6.47715 22 12 22V2C6.47715 2 2 6.47715 2 12Z" fill="currentColor" opacity="0.12" />
		<path
