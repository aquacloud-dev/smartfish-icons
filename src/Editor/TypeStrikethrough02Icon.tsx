...
const TypeStrikethrough02Icon = forwardRef<SVGSVGElement, ISVGProps>((props, ref) => (
	<svg height="24" width="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" ref={ref} {...props}>
		<path d="M10.25 20.0002V10.2915L13.75 13.8261V20.0002H10.25Z" fill="currentColor" opacity="0.12" />
		<path
